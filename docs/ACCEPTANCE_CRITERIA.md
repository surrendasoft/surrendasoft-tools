...
| AC-TEXTQR | QR Text Transfer | Encodes short text into a same-site QR URL without a backend; opens and decodes the receive route locally; supports copy, safe-link opening, QR download, camera scanning, and QR-image upload; warns above 1,200 characters and blocks above 1,800. |
